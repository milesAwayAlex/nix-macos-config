...
| nixpkgs | `nixpkgs-unstable`, weekly lock bumps via `update-flake-lock` action | Community-tested path for darwin; bot keeps deltas small. Stable-branch fallback documented if churn hurts. |
