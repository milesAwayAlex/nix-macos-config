...
Steps a fresh machine needs that the flake cannot do for itself. Completed in
Phase 5 from the checklist in `PLAN.md`; entries land here as the decisions that
create them are made.
